...
const canvas = document.getElementById('gameCanvas');  // canvas ID-ийг шалгаарай
...
// TimeStep adjustment for smoother simulation
const timeStep = 1 / 60;  // Time step for the physics simulation
...
function animate() {
  ...
  // Update the position of each object with the physics engine
